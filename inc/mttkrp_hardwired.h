...
int mttkrp_hardwired_first_not_fused_3(csf* t, int mode, int r, matrix** mats, int profile = -1);
int mttkrp_hardwired_first_not_fused_4(csf* t, int mode, int r, matrix** mats, int profile = -1);
int mttkrp_hardwired_first_not_fused_5(csf* t, int mode, int r, matrix** mats, int profile = -1);
